...
const FindOptions = () => {
    ...
    const isDomainSelect = useMatch("/domain");
    const isNoDomainSelect = useMatch("/no-domain");
    const isDomainNotSelect = useMatch("/add-to-cart");

    return (
        <div className='md:py-16 sm:py-14 py-10'>
            <div className='max-w-5xl mx-auto'>
                <div className='searcharea w-full text-center'>
                    <h2 className='mb-12'>Find more options</h2>
                </div>
                    ...
                    <div className='domain-list'> 
                        ...
                        <div>
                            <div className='flex items-center justify-between gap-2 p-2.5'>
                                <h2 className='flex flex-wrap items-center card-title'>
                                    ...
                                    <span className='text-darkbtn dark:text-white'> .blue</span>
                                </h2>
                                ...
                                <div className='flex items-center gap-4 domainlist-detail'>
                                    ...
                                    <div className='text-left min-w-36'>
                                        ...
                                        <p className='price-tag'>$19.49 <span>$31.99</span></p>
                                    </div>
                        ...
                        <div>
                            <div className='flex items-center justify-between gap-2 p-2.5'>
                                ...
                                {/* rightside text */}
                                <div className='flex items-center gap-4 domainlist-detail'>
                                    <span className='save-lable bg-tealdark'>Save 22%</span>
                                    <div className='text-left min-w-36'>
                                        <p className='price-tag'>$24.99 <span>$44.99</span></p>
                                    </div>
                                    <div className='flex justify-start'>
                                        <a href='#' className='btn-outline'>
                                            <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        { (isDomainSelect || isNoDomainSelect) &&
                            <div>
                                <div className='flex items-center justify-between gap-2 p-2.5'>
                                    <h2 className='flex flex-wrap items-center card-title'>
                                        <span className='text-primary dark:text-gray-500'>apple</span>
                                    ...
                                    {/* rightside text */}
                                    <div className='flex items-center gap-4 domainlist-detail'>
                                        <span className='save-lable bg-tealdark'>Save 43%</span>
                                        <div className='text-left min-w-36'>
                                            <p className='price-tag'>$18.99 <span>$31.99</span></p>
                                        </div>
                                        <div className='flex justify-start'>
                                            <a href='#' className='btn-outline'>
                                                <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className='flex items-center justify-between gap-2'>
                                    <div className="flex flex-col items-start justify-between gap-2">
                                        ...
                                        <h2 className='flex flex-wrap items-center card-title'>
                                            ...
                                            <span className='text-primary dark:text-white'>apple</span>
                                            <span className='text-darkbtn dark:text-white'>.org</span>
                                            <span className='text-primary dark:text-white'> + .store + .shop</span>
                                        </h2>
                                    </div>
                        ...
                        <div>
                            <div className='flex items-center justify-between gap-2 p-2.5'>
                                <h2 className='flex flex-wrap items-center card-title'>
                                    <span className='text-primary dark:text-gray-500'>apple</span>
                                    <span className='text-darkbtn dark:text-white'> .tech</span>
                                </h2>

                                {/* rightside text */}
                                <div className='flex items-center gap-4 domainlist-detail'>
                                    <span className='save-lable bg-tealdark'>Save 12%</span>
                                    <div className='text-left min-w-36'>
                                        <p className='flex text-primary dark:text-white text-xs font-medium gap-1.5 items-center'>
                                            For the first year 
                                            <FiInfo />
                                        </p>
                                        <p className='price-tag'>$12.49 <span>$19.99</span></p>
                                    </div>
                                    <div className='flex justify-start'>
                                        <a href='#' className='btn-outline'>
                                            <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div>
                            <div className='flex items-center justify-between gap-2 p-2.5'>
                                <h2 className='flex flex-wrap items-center card-title'>
                                    <span className='text-primary dark:text-gray-500'>apple</span>
                                    <span className='text-darkbtn dark:text-white'> .shop</span>
                                </h2>

                                {/* rightside text */}
                                <div className='flex items-center gap-4 domainlist-detail'>
                                    <div className='text-left min-w-36'>
                                        <p className='price-tag'>$24.99</p>
                                    </div>
                                    <div className='flex justify-start'>
                                        <a href='#' className='btn-outline'>
                                            <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div>
                            <div className='flex items-center justify-between gap-2 p-2.5'>
                                <h2 className='flex flex-wrap items-center card-title'>
                                    <span className='text-primary dark:text-gray-500'>apple</span>
                                    <span className='text-darkbtn dark:text-white'> .store</span>
                                </h2>
                        ...
                        <div>
                            <div className='flex items-center justify-between gap-2 p-2.5'>
                                <h2 className='flex flex-wrap items-center card-title'>
                                    <span className='text-primary dark:text-gray-500'>apple</span>
                                    <span className='text-darkbtn dark:text-white'> .info</span>
                                </h2>
                        ...
                        <div>
                            <div className='flex items-center justify-between gap-2 p-2.5'>
                                <h2 className='flex flex-wrap items-center card-title'>
                                    <span className='text-primary dark:text-gray-500'>apple</span>
                                    <span className='text-darkbtn dark:text-white'> .io</span>
                                </h2>
                    ...
                    <div className='flex justify-center mt-12'>
                        <a href='#' className='btn-outline w-40'>
                            <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M14.0494 8.60267C14.1812 8.61581 14.3025 8.68077 14.3865 8.78328C14.4705 8.88578 14.5104 9.01745 14.4974 9.14933C14.1707 12.436 11.392 15 8.01469 15C6.19869 15 4.43869 14.378 3.18935 13.2133L2.00002 14.4C1.86741 14.4 1.74023 14.3473 1.64646 14.2536C1.5527 14.1598 1.50002 14.0326 1.50002 13.9V11.26C1.50002 10.784 1.88669 10.4 2.36069 10.4H5.00735C5.13996 10.4 5.26714 10.4527 5.36091 10.5464C5.45467 10.6402 5.50735 10.7674 5.50735 10.9L3.89869 12.5047C4.93735 13.46 6.41869 14 8.01469 14C10.8747 14 13.226 11.828 13.5027 9.05067C13.5158 8.91879 13.5808 8.79753 13.6833 8.71352C13.7858 8.62952 13.9175 8.58964 14.0494 8.60267ZM1.50269 7.85067C1.82935 4.564 4.60802 2 7.98535 2C9.80135 2 11.5614 2.622 12.8107 3.78667L14 2.6C14.1326 2.6 14.2598 2.65268 14.3536 2.74645C14.4473 2.84021 14.5 2.96739 14.5 3.1V5.74C14.5 6.216 14.1134 6.6 13.6394 6.6H10.9927C10.8601 6.6 10.7329 6.54732 10.6391 6.45355C10.5454 6.35979 10.4927 6.23261 10.4927 6.1L12.1014 4.49467C11.0627 3.54 9.58135 3 7.98535 3C5.12535 3 2.77402 5.172 2.49735 7.94933C2.49275 8.0161 2.47479 8.08126 2.44454 8.14096C2.41429 8.20066 2.37236 8.25368 2.32124 8.29687C2.27012 8.34007 2.21085 8.37256 2.14694 8.39242C2.08303 8.41229 2.01578 8.41912 1.94918 8.41251C1.88258 8.4059 1.81799 8.38599 1.75922 8.35396C1.70046 8.32193 1.64873 8.27843 1.60709 8.22603C1.56545 8.17364 1.53476 8.11342 1.51682 8.04894C1.49889 7.98446 1.49408 7.91704 1.50269 7.85067Z" fill="currentcolor"/>
                            </svg>
                            Load more
                        </a>
                    </div>
