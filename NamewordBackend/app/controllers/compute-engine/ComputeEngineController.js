...
🖥 *Instance Name:* ${TelegramService.escapeMarkdown(sanitizedCredentials.instanceName)}
🌐 *Plesk Login:* [🔗 Click here](${sanitizedCredentials.loginUrl})
🔄 *Reset Password:* [🔗 Reset here](${sanitizedCredentials.resetLink})
${
	sanitizedCredentials.tempLink
		? `📌 *Temporary Access:* [Click here](${sanitizedCredentials.tempLink})`
		: ""
}
...
🖥 *Instance Name:* ${TelegramService.escapeMarkdown(sanitizedCredentials.instanceName)}
🌐 *Plesk URL:* [🔗 Click here](${sanitizedCredentials.loginUrl})
${
	sanitizedCredentials.tempLink
		? `📌 *Temporary URL:* [🔗 Click here](${sanitizedCredentials.tempLink})`
		: ""
}
